...
COIN_REPO='https://github.com/allcoinguru/mninstall-allcoin/releases/download/daemon/AgenaCore.tar.gz'
SENTINEL_REPO='https://github.com/agenadev/sentinel'
COIN_NAME='AGENA'
COIN_PORT=1984
RPC_PORT=20724
COINKEY=$1
...
function compile_node() {
  ...
  compile_error
  cp usr/local/bin/agena* /usr/local/bin
  compile_error
